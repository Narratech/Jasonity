...
/* Initial goals */
public Literal  initial_goal() { Literal g;            
    jj_consume_token(38);
     g = literal();
    jj_consume_token(37);
...
public PlanBody  plan_body_factor() { Object F; PlanBody R = null;                              
...
public PlanBody  stmtIF() { PlanBody B;             
...
public PlanBody  stmtIFCommon() { Object B; Term T1; Term T2 = null; Literal stmtLiteral = null;                                                                
    jj_consume_token(46);
...
public PlanBody  stmtFOR() { Object B; Term T1; Literal stmtLiteral;                                         
...
public PlanBody  stmtWHILE() { Object B; Term T1; Literal stmtLiteral;                                         
...
public Object  body_formula() { BodyType formType = BodyType.action;  Object B;                                                 
...
/* List of terms */
public List  terms() { ArrayList listTerms = new ArrayList(); Term v; PlanBody o;                                                            
...
public Term  term_in_list() { Object o;           
...
public Object  log_expr() { Object t1, t2;                
...
public Object  log_expr_trm() { Object t1, t2;                
...
public Object  log_expr_factor() { Object t;           
...
*/
public Object  rel_expr() {  Object op1 = null;
                                             Object op2 = null;
...
public Object  arithm_expr() { Object t1, t2; ArithmeticOp op;                                 
...
public Object  arithm_expr_trm() { Object t1, t2; ArithmeticOp op;                                 
...
public Object  arithm_expr_factor() { Object t1, t2; ArithmeticOp op;
...
public Object  arithm_expr_simple() { Token K; Object t; VarTerm v;                               
...
public Term  function() { Literal l;            
...
public VarTerm  var(Atom ns) { Token K; VarTerm v; ListTerm lt = null;                                         
...
public StringTerm  string() { Token k; StringTermImpl s;                            
